...
public class RecycleViewFragmentDelivering extends RecyclerView.Adapter<RecycleViewFragmentDelivering.ViewHolder> {
    private final ArrayList<Order> orderList;
    private final Context context;

    public RecycleViewFragmentDelivering(ArrayList<Order> orderList, Context context) {
    ...
    @NonNull
    @Override
    public RecycleViewFragmentDelivering.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_item_delivery_shipper,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecycleViewFragmentDelivering.ViewHolder holder, int position) {
