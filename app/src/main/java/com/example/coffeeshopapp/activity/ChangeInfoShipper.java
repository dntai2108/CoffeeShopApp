...
import com.example.coffeeshopapp.databinding.ActivityChangeInfoShipperBinding;
...
public class ChangeInfoShipper extends AppCompatActivity {

    private ActivityChangeInfoShipperBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityChangeInfoShipperBinding.inflate(getLayoutInflater());
    ...
    private void setEven() {
        ...
        binding.btnChangeInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                customerReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                            ...
                            if (customer.getPhone().equals(phone)) {
                                ...
                                Toast.makeText(ChangeInfoShipper.this, "Cập nhật thành công", Toast.LENGTH_SHORT).show();
                                String role = getIntent().getStringExtra("role");
                                Intent intent = new Intent(ChangeInfoShipper.this, ProfileShipperActivity.class);
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(ChangeInfoShipper.this, "Cập nhật không thành công", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        ...
        binding.ivQuayLai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ChangeInfoShipper.this, BottomNavigationActivityShipper.class);
                startActivity(intent);
            }
        });
    }
