...
import com.example.coffeeshopapp.databinding.ActivityChangePasswordShipperBinding;
...
public class ChangePasswordShipper extends AppCompatActivity {

    private ActivityChangePasswordShipperBinding binding;
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityChangePasswordShipperBinding.inflate(getLayoutInflater());
        ...
        binding.btnXacNhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(password)) {
                    Toast.makeText(ChangePasswordShipper.this, "Mật khẩu không được để trống", Toast.LENGTH_SHORT).show();
                    binding.edtMatKhauCu.setError("Nhập mật khẩu cũ: ");
                    binding.edtMatKhauCu.requestFocus();
                    return;
                }
                if (!matKhauCu.equals(password)) {
                    Toast.makeText(ChangePasswordShipper.this, "Mật khẩu cũ không chính xác", Toast.LENGTH_SHORT).show();
                    binding.edtMatKhauCu.setError("Nhập mật khẩu cũ: ");
                    binding.edtMatKhauCu.requestFocus();
                    return;
                }
                ...
                if (TextUtils.isEmpty(xacNhanMatKhau)) {
                    Toast.makeText(ChangePasswordShipper.this, "Mật khẩu xác nhận không được để trống", Toast.LENGTH_SHORT).show();
                    binding.edtXacNhanMatKhau.setError("Nhập lại mật khẩu xác nhận: ");
                    binding.edtXacNhanMatKhau.requestFocus();
                    return;
                }
                if (matKhauCu.equals(matKhauMoi)) {
                    Toast.makeText(ChangePasswordShipper.this, "Mật khẩu mới phải khác mật khẩu cũ", Toast.LENGTH_SHORT).show();
                    binding.edtXacNhanMatKhau.setError("Nhập lại mật khẩu: ");
                    binding.edtXacNhanMatKhau.requestFocus();
                    return;
                }
                if (!matKhauMoi.equals(xacNhanMatKhau)) {
                    Toast.makeText(ChangePasswordShipper.this, "Mật khẩu xác nhận không trùng khớp", Toast.LENGTH_SHORT).show();
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                            ...
                            if (customer.getAccount().getUsername().equals(phone)) {
                                ...
                                Toast.makeText(ChangePasswordShipper.this, "Mật khẩu đã được thay đổi thành công", Toast.LENGTH_SHORT).show();
                                break;
                            }
                        }
                    }
                ...
                Intent intent = new Intent(ChangePasswordShipper.this, BottomNavigationActivityShipper.class);
