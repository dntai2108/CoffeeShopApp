...
dependencies {
  ...
  //  implementation ("com.paypal.checkout:android-sdk:1.1.0")
    ...
    //  implementation ("com.zing.zalo.zalosdk:payment:1.0.0")

// zalopay
   /* implementation("com.squareup.okhttp3:okhttp:4.6.0")
    implementation("commons-codec:commons-codec:1.14")
    implementation(files("C:\\Users\\Legion 5\\Desktop\\android\\zalopay\\DemoZPDK_Android\\ZPDK-Android\\zpdk-release-v3.1.aar"))
*/
